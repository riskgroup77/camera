...
DEFAULT_AI_MODULES = [
    ...
    {"code": 12, "group": "C", "name": "ID-badge taqilganligi", "description": "Xodim/talaba identifikatsiya kartochkasi ko'rinishda ekanligi", "method": "Object detection (kichik obyekt, yaqin kamera talab qiladi)", "accuracy": 0, "threshold": 70, "sensitivity": "o'rta", "camera_count": 0, "active": False, "has_detector": False},
    {"code": 13, "group": "C", "name": "Qo'lqop/niqob (kerakli xonalarda)", "description": "Sanitariya talab qiladigan zonalarda SIZ mavjudligi", "method": "PPE detection modeli", "accuracy": 0, "threshold": 85, "sensitivity": "yuqori", "camera_count": 0, "active": False, "has_detector": False},
    ...
    {"code": 15, "group": "D", "name": "Chekish / elektron sigareta", "description": "Bino ichida yoki hovlida chekish holatlari", "method": "Obyekt + tutun/harakat klassifikatori", "accuracy": 0, "threshold": 75, "sensitivity": "o'rta", "camera_count": 0, "active": False, "has_detector": False},
    ...
    {"code": 18, "group": "D", "name": "Kiyim-bosh (dress code) umumiy", "description": "Talabalarning institut nizomiga mos kiyingani", "method": "Kiyim klassifikatsiyasi", "accuracy": 0, "threshold": 70, "sensitivity": "o'rta", "camera_count": 0, "active": False, "has_detector": False},
