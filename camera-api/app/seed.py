...
DEFAULT_AI_MODULES = [
    ...
    {"code": 18, "group": "D", "name": "Kiyim-bosh (dress code) umumiy", "description": "Tanilgan talaba uchun yuqori/pastki tana yorqinlik kontrasti evristikasi", "method": "Face-ID talaba filtri + HSV kontrast (app/jobs/student_dress_code_ai.py)", "accuracy": 0, "threshold": 35, "sensitivity": "o'rta", "camera_count": 0, "active": False, "has_detector": True},
