  ...
  return (
    ...
    >
      <div className="relative flex aspect-video items-center justify-center overflow-hidden rounded-xl bg-slate-900">
        ...
        {isLive ? (
          <>
            <span className="absolute left-2 top-2 z-10 flex items-center gap-1 rounded-full bg-emerald-500/90 px-2 py-0.5 text-[10px] font-bold text-white">
              <Circle size={6} className="fill-white" />
              JONLI
            </span>
            <span className="absolute right-2 top-2 z-10 flex items-center gap-1 rounded-full bg-red-500/90 px-2 py-0.5 text-[10px] font-bold text-white">
              REC
            </span>
          </>
        ) : (
